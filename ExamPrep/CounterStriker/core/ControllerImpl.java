...
public class ControllerImpl implements Controller {
    ...
    public String addPlayer(String type, String username, int health, int armor, String gunName) {
        ...
        switch (type) {
            case "CounterTerrorist":
                player = new CounterTerrorist(username, health, armor, gunP);
                break;
            case "Terrorist":
                player = new Terrorist(username, health, armor, gunP);
                break;
            default:
    ...
    public String startGame() {
        List<Player> alivePlayers = players.getModels().stream()
    ...
    public String report() {
        ...
        this.players
                ...
                .forEach(p -> out.append(p.toString()).append(System.lineSeparator()));
